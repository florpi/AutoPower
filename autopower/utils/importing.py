"""
Provide a function to import classes and functions by their name.
"""
...
def get_class_by_name(module_name: str,
    ...
    (e.g., 'LinearRegression') as the inputs, and tries to import said
    class from the given module.
